...
<section class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-white">
    ...
    <form action="search" method="get" class="bg-white p-6 rounded-2xl shadow-lg w-fit md:w-full md:max-w-6xl space-y-8">
        <div class="grid md:grid-cols-3 gap-4">
            <input type="text" name="depart" placeholder="Départ" required list="startOptions" 
                   class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                   <datalist id="startOptions">
                    <% 
                        List<String> startTown = (List<String>) request.getAttribute("startTown");
                        if (startTown != null) {
                            for (String town : startTown) {
                    %>
