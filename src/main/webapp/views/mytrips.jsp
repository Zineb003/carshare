...
<section class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-white">
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold text-center mb-6">Mes trajets</h1>
            ...
            %>
                <div class="bg-white rounded-2xl shadow p-5 hover:shadow-lg transition">
                    ...
                    <div class="text-sm text-gray-600 mb-2">
                        Départ : <strong><%= trip.getStartDate() %></strong><br>
                    ...
                    %>
                        <p class="text-sm text-gray-500 mt-2"><%= trip.getDescription() %></p>
                    <%
                        }
                    %>
                </div>
        ...
        %>
            <p class="text-center text-gray-600">Vous n'avez encore publié aucun trajet.</p>
        <%
            }
        %>
